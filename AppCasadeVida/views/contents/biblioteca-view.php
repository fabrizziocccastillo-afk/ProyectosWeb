...
<div class="container-fluid">
	<div class="page-header">
	  <h1 class="text-titles"><i class="zmdi zmdi-tv-alt-play zmdi-hc-fw"></i> Libros <small>(Registro)</small></h1>
	</div>
	<p class="lead">
		Bienvenido a la sección de Biblioteca, aquí podrás registrar nuevos Libros (Los campos marcados con * son obligatorios para registrar un nuevo Libro).
	</p>
</div>
<div class="container-fluid">
			...
			<div class="panel panel-info">
				<div class="panel-heading">
			  	...
			  	<div class="panel-body">
				    <form action="<?php echo SERVERURL; ?>ajax/ajaxBiblioteca.php" method="POST" enctype="multipart/form-data" autocomplete="off" data-form="AddVideo" class="ajaxDataForm">
				    	<fieldset class="full-box">
				    		<legend><i class="zmdi zmdi-book"></i> Datos del Libro</legend>
				    		<div class="container-fluid">
				    			<div class="row">
				    				<div class="col-xs-12 col-sm-6">
								    	<div class="form-group label-floating">
										  	<span class="control-label">Nombre del Libro *</span>
				    				...
				    				<div class="col-xs-12 col-sm-6">
								    	<div class="form-group label-floating">
										  	<span class="control-label">Tutor o Docente que Recomienda *</span>
