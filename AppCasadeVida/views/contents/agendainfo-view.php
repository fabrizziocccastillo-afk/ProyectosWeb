...
<div class="container-fluid">
	<div class="page-header">
	  <h1 class="text-titles"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Libro</h1>
	</div>
	<p class="lead">
		Bienvenido a la sección de actualización de los datos de los libros. Acá podrá actualizar la información del Libro.
	</p>
</div>
<?php 
	...
	if(isset($_POST['idAtt']) && isset($_POST['nameAtt'])){
		echo $insagenda->delete_agenda_attachment_controller($_POST['idAtt'],$_POST['nameAtt'],$urls);
	}

	$code=explode("/", $_GET['views']);

	$data=$insagenda->data_agenda_controller("Only",$code[1]);
	if($data->rowCount()>0):
		$rows=$data->fetch();
?>
<p class="text-center">
	<a href="<?php echo SERVERURL; ?>agendalist/" class="btn btn-info btn-raised btn-sm">
											...
											<tr>
												...
												<td>
													...
													<form action="" method="POST" enctype="multipart/form-data" autocomplete="off" id="delete-att-<?php $catt; ?>">
			    										<input type="hidden" name="idAtt" value="<?php echo $rows['idagenda']; ?>">
		...
		<div class="col-xs-12">
			<div class="panel panel-success">
				<div class="panel-heading">
			  	...
			  	<div class="panel-body">
				    <form action="<?php echo SERVERURL; ?>ajax/ajaxAgenda.php" method="POST" enctype="multipart/form-data" autocomplete="off" data-form="UpdateVideo" class="ajaxDataForm">
				    	<input type="hidden" name="upid" value="<?php echo $rows['idagenda']; ?>">
