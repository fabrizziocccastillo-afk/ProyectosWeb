...
<div class="container-fluid">
	<div class="page-header">
	  <h1 class="text-titles"><i class="zmdi zmdi-face zmdi-hc-fw"></i> Discipulado <small>(CDV)</small></h1>
	</div>
	<p class="lead">
...
<div class="container-fluid">
	<ul class="breadcrumb breadcrumb-tabs">
	  	...
	  	<li>--->
	  		<a id="lista" href="<?php echo SERVERURL; ?>reporteintegrantelist/" class="btn btn-success">
...
<?php  
	...
	$insIntegrante = new reporteintegranteController();
	$Inactivo=0;
   ...
   if($Inactivo){
	echo "<script type='text/javascript'>window.setTimeout(function(){window.location='".SERVERURL."/reporteintegrantelist/'}, 2000)</script>";
	}
