...
<div class="container-fluid">
	<ul class="breadcrumb breadcrumb-tabs">
	  	...
	  	<li>
	  		<a id="lista" href="<?php echo SERVERURL; ?>studentlist/" class="btn btn-success">
	  			<i class="zmdi zmdi-format-list-bulleted"></i> Lista
	  		</a>
		  </li>
		  <div class="search-box">
				   <input type="text" class="search-txt" name="caja_busqueda" id="caja_busqueda"  placeholder="Search..">
		...
		<div class="col-xs-12">
	  		<div class="panel panel-success">
			  	...
			  	<div class="panel-body">
					<div id="datos1" class="table-responsive">
					<?php
						$page=explode("/", $_GET['views']); 
					?>
					<input type="hidden" id="pagina" name="pagina" value="<?php	echo $page[1];?>">
					</div>
