...
<!--	<div class="page-header">
	...
	<p class="lead">
		Bienvenido en esta sección aquí puede buscar alguna informacion por integrante de CDV.
	</p>
</div>
<?php 
		...
		<div class="col-xs-12">
			<div class="panel panel-success">
			  	<div class="panel-heading">
			    	<h3 class="panel-title"><i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; Lista de búsqueda "<?php echo $_SESSION['search']; ?>"</h3>
			  	</div>
