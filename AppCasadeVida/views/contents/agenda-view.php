...
<div class="container-fluid">
	<div class="page-header">
	  <h1 class="text-titles"><i class="zmdi zmdi-view-agenda zmdi-hc-fw"></i> Agenda <small>(Registro)</small></h1>
	</div>
	<p class="lead">
		Bienvenido a la sección de Agenda, aquí podrás registrar una nueva Agenda (Los campos marcados con * son obligatorios para registrar una nueva Agenda).
	</p>
</div>
<div class="container-fluid">
		...
		<div class="col-xs-12">
			<div class="panel panel-info">
				<div class="panel-heading">
				    <h3 class="panel-title"><i class="zmdi zmdi-plus"></i> Nueva Agenda</h3>
				</div>
			  	<div class="panel-body">
				    <form action="<?php echo SERVERURL; ?>ajax/ajaxAgenda.php" method="POST" enctype="multipart/form-data" autocomplete="off" data-form="AddVideo" class="ajaxDataForm">
				    	<fieldset class="full-box">
				    		<legend><i class="zmdi zmdi-view-agenda"></i> Datos de Agenda</legend>
				    		<div class="container-fluid">
				    			<div class="row">
