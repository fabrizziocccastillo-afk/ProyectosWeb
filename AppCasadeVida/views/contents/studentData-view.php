...
<div class="container-fluid">
	...
	<p class="lead">
		Bienvenido a la sección de actualización de los datos del estudiantes. Usted podrá actualizar la información personal cuando se lo requiera.
	</p>
</div>
<p class="text-center">
	<a href="<?php echo SERVERURL; ?>studentData/" class="btn btn-info btn-raised btn-sm">
...
<?php 
	...
	if(isset($_POST['code'])){
		...
		echo $studentIns->foto_student_controller($_POST['code']);
		echo "<script type='text/javascript'>window.location='SERVERURL/studentData/';<script>";
	}

	$data=$studentIns->data_student_actualiza_controller("Only",$UsuarioActualiza);
	if($data->rowCount()>0):
		$rows=$data->fetch();
?>
<div class="container-fluid">
