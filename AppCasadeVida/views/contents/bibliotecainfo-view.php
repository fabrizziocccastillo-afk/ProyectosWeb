...
<?php 
	...
	if(isset($_POST['idAtt']) && isset($_POST['nameAtt'])){
		echo $insBiblioteca->delete_biblioteca_attachment_controller($_POST['idAtt'],$_POST['nameAtt'],$urls);
	}
...
?>
<p class="text-center">
	<a href="<?php echo SERVERURL; ?>bibliotecalist/" class="btn btn-info btn-raised btn-sm">
											...
											<tr>
												...
												<td>
													...
													<form action="" method="POST" enctype="multipart/form-data" autocomplete="off" id="delete-att-<?php $catt; ?>">
			    										<input type="hidden" name="idAtt" value="<?php echo $rows['idbiblioteca']; ?>">
				...
				<div class="panel-heading">
			  	...
			  	<div class="panel-body">
				    <form action="<?php echo SERVERURL; ?>ajax/ajaxVideo.php" method="POST" enctype="multipart/form-data" autocomplete="off" data-form="UpdateVideo" class="ajaxDataForm">
				    	<input type="hidden" name="upid" value="<?php echo $rows['idbiblioteca']; ?>">
				    			...
				    			<div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
								    	<div class="form-group label-floating">
										  	...
										  	<input class="form-control" type="text" name="autor" value="<?php echo $rows['Autor']; ?>" required="">
										</div>
				    				</div>
				    				<div class="col-xs-12 col-sm-6">
								    	<div class="form-group label-floating">
