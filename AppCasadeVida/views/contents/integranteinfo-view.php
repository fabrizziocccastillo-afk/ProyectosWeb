...
<div class="container-fluid">
	<div class="page-header">
	  <h1 class="text-titles"><i class="zmdi zmdi-settings zmdi-hc-fw"></i> Datos del Integrante</h1>
	</div>
	<p class="lead">
		Bienvenido a la sección de actualización de los datos del Integrante CDV. Usted podrá actualizar la información personal cuando se lo requiera.
	</p>
</div>
<p class="text-center">
	<a href="<?php echo SERVERURL; ?>integrantelist/" class="btn btn-info btn-raised btn-sm">
...
<?php 
   ...
   // $UsuarioActualiza = $_SESSION['userName'];
	...
	$data=$integranteins->data_integrante_actualiza_adm_controller("Only",$code[1]);
	if($data->rowCount()>0):
		$rows=$data->fetch();
?>
<div class="container-fluid">
				    ...
				    <form action="" method="POST" enctype="multipart/form-data" autocomplete="off">
				    	<fieldset>
				    		...
				    		<div class="container-fluid">
				    			<div class="row">
				    				...
				    				<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										  	<label class="zmdi zmdi-home" class="control-label"> Dirección </label>
									...
									<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										    <label class="zmdi zmdi-graduation-cap" class="control-label"> Instruccion Academica </label>
										  	<input class="form-control" type="text" name="instruccion" id="instruccion" value="<?php echo $rows['instruccion']; ?>">
										</div>
				    				</div>	
									<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										    <label class="zmdi zmdi-star-outline" class="control-label"> Profesion </label>
										  	<input class="form-control" type="text" name="profesion" id="profesion" value="<?php echo $rows['profesion']; ?>">
										</div>
				    				</div>	
									<!--- <div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
								...
								<!---	<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										    <SPAN class="control-label">Fecha de Conversión </SPAN>
										  	<input class="form-control" type="date" value="<?php echo $rows['fechaconversion']; ?>" name="fechaconversion" id="fechaconversion">
										</div>
				    				</div>	--->
									<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">	
									...
									<option value="<?php echo $rows['estudios']; ?>"><?php echo $rows['estudios']; ?></option>
						...
						<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										  	...
										  	<option value="<?php echo $rows['idcargo'];?>"><?php echo $rows['cargo'];?></option>				  		
						...
						<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										  	...
										  	<option value="<?php echo $rows['idarea']; ?>"><?php echo $rows['area']; ?></option>				  		
					...
					<!---	<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										    <SPAN class="control-label">Fecha de Inicio del Servicio </SPAN>
										  	<input class="form-control" type="date" value="<?php echo $rows['fechainicioservicio']; ?>" name="fechainiservicio" id="fechainiservicio">
										</div>
				    	</div>	
						<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										    <SPAN class="control-label">Fecha de Finalizacion del Servicio </SPAN>
										  	<input class="form-control" type="date" value="<?php echo $rows['fechafinservicio']; ?>" name="fechafinservicio" id="fechafinservicio">
										</div>
				    	</div>-->	
						<?php 
				    				   if($rows['estado']==0){
										  ...
										  echo '<div id="observa" style="'.$Estilo.'" class="col-xs-12 col-sm-6">';
										  // echo 'Estilo1:------------------------  '.$Estilo.'  Estado1: '.$rows['estado'];
										}else{
											$Estilo='';
											$Estilo='display:none;';
										   echo '<div id="observa" style="'.$Estilo.'" class="col-xs-12 col-sm-6">';

											//echo 'Estilo2:------------------------  '.$Estilo.'  Estado2: '.$rows['estado'];
										}
				    	...
				    	?>
                                        ...
                                        <div class="form-group label-floating">
										<SPAN class="zmdi zmdi-format-color-text" for="observacion"> Observación del Integrante</SPAN>
										  	<textarea class="form-control" id="observacion" name="observacion" rows="3"><?php echo $rows['observacion']; ?></textarea>
										</div>
						</div>
						<!-- Discipulado-->
						<div class="col-xs-12 col-sm-6">
									...
									<option value="<?php echo $rows['discipulado']; ?>"><?php echo $rows['discipulado']; ?></option>
