				    	...
				    	-->
				    		...
				    		<div class="container-fluid">
				    			...
				    			<div class="col-xs-12 col-sm-2">
										   ...
										   <div class="card">  -->
										   <img src="/ESCOL/Backend/imagenes/<?php echo $rows['fotomaestro']; ?>" height="150" class="card-img-top"> 
										   <!--</div>
										   </div> -->
								</div>
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        ...
                                        <li>
                                            <a href="#!" id="eval" onclick="javascript:showContent3()">
                                                <i class="zmdi zmdi-layers zmdi-hc-fw"></i> Evaluaciones
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="#!" id="tarea" onclick="javascript:showContent6()">
                                                <i class="zmdi zmdi-layers zmdi-hc-fw"></i> Proyecto Final
                                            </a>
                                        </li>
                                        </ul>
                                          ...
                                          <div id="clasedia" style="display:none;">
				    			            ...
				    			            <div class="row">								
												...
												<form action="" method="POST" enctype="multipart/form-data" autocomplete="off">
													...
													<div>
													<input id="promateria" type="text" name="promateria" value="<?php echo $rows['idmateria']; ?>">
													<input id="procodigo" type="text" name="procodigo" value="<?php echo $rows['Codigo']; ?>">
													<input id="procorreo" type="text" name="procorreo" value="<?php echo $rows['correo']; ?>">
													</div>
													<br><br>
													   <p class="text-center">
