...
<div class="container-fluid">
	<div class="page-header">
	  <h1 class="text-titles"><i class="zmdi zmdi-view-agenda zmdi-hc-fw"></i> Agenda de Servicio</h1>
	</div>
	<p class="lead">
		En esta sección podra ver la agenda de servicio semanal de todas las actividades.
	</p>
</div>
<!--<p class="text-center">
	<a href="<?php //echo SERVERURL; ?>agendapublicada/" class="btn btn-info btn-raised btn-sm">
...
<?php 
    ...
    $agendaIns = new agendaController();
    //0UsuarioActualiza = $_SESSION['userName'];

	/*if(isset($_POST['code'])){
		echo $agendaIns->update_student_controller();
		echo $studeagendaInsntIns->foto_student_controller($_POST['code']);
		echo "<script type='text/javascript'>window.location='SERVERURL/studentData/';<script>";
	}*/

	$data=$agendaIns->data_agenda_controller("Count",0);
			  	...
			  	<div class="panel-body">
				    <form action="" method="POST" enctype="multipart/form-data" autocomplete="off">
				    	<fieldset>
				    		...
				    		<input type="hidden" name="code" value="<?php echo $rows['idagenda']; ?>">
				    		<div class="container-fluid">
				    			<div class="row">
...
<?php 
	...
	<p class="lead text-center">Lo sentimos no hay agenda por publicar</p>
<?php
		endif;
	else:
