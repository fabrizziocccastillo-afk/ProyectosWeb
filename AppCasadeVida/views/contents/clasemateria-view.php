<div class="container-fluid">
	...
	<p class="lead">
		En esta sección puede ver el listado de todas las Materias asignadas en la Plataforma <strong><?php echo COMPANY; ?></strong>. Haga clic en el botón 
			  	...
			  	<div class="panel-body">
					<div class="table-responsive">
						<?php
							...
							echo $insVideo->pagination_ClasexMateria_list_controller($page[1],10);
						?>
					</div>
			  	</div>
			</div>
