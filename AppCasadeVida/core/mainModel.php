<?php
	...
	class mainModel{
		...
		public function save_account($data){
			$query=self::connect()->prepare("INSERT INTO cuenta(Privilegio,Usuario,Clave,Tipo,Codigo,Genero,idrol) VALUES(:Privilegio,:Usuario,:Clave,:Tipo,:Codigo,:Genero,:idrol)");
			...
			$query->bindParam(":idrol",$data['idrol']);
			$query->execute();
			return $query;
		}
